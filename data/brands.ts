...
export const BRANDS: Brand[] = [
  ...
  { slug: 'ipekstil', name: 'İpekstil', homepage: 'https://ipekstil.com', feedUrl: 'https://ipekstil.com/products.json', community: 'hijabi', currency: 'TRY', category: 'Abayas', city: 'Istanbul', vibe: 'elegant' },
  ...
  { slug: 'zaskia-sungkar', name: 'Zaskia Sungkar', homepage: 'https://zaskiasungkar.com', feedUrl: 'https://zaskiasungkar.com/products.json', community: 'hijabi', currency: 'IDR', category: 'Abayas & modest dresses', city: 'Jakarta', vibe: 'elegant' },
